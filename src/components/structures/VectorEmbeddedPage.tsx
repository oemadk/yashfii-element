...
export default class VectorEmbeddedPage extends EmbeddedPage {
    ...
    translate(s: string) {
        ...
        s = s.replace(/\[matrix\]/, '<a href="https://matrix.org" target="_blank" rel="noreferrer noopener"><img width="79" height="34" alt="Matrix" style="padding-left: 1px;vertical-align: middle" src="themes/element/img/logos/yashfii-logo.svg"/></a>');
        return s;
    }
}
